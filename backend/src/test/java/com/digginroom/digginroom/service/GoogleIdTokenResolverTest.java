...
import com.digginroom.digginroom.oauth.google.GoogleIdTokenVerifier;
...
class GoogleIdTokenResolverTest {
    ...
    private final GoogleIdTokenResolver resolver = new GoogleIdTokenResolver(new GoogleIdTokenVerifier());
